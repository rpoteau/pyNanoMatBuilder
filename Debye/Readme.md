...
- crysol (external program https://www.embl-hamburg.de/biosaxs/manuals/crysol.html#cli) - takes pdb format as input - can take into account the dispersive component for anomalous investigations FILE:
...
- sasview (python library) - takes pdb as input - does not account for anomalous effects. (https://www.sasview.org/docs/user/qtgui/Calculators/sas_calculator_help.html#)
