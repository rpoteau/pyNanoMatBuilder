...
- docstrings issues in `crystallographic_angle`, `applyTwist`, `defSlabShapeForJMol`

### Changed

- in `utils.prop.py`, `moi()` function renamed as `compute_moi()`, to avoid warning issues generated by sphinx
